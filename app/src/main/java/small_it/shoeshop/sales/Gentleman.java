...
/**
 * Class to display all the shoes for the gentleman ;-)
 *
 ...
 * ! Hardcoded Data !
 */
public class Gentleman extends AppCompatActivity implements SmallCards.ClickListener, View.OnClickListener{
    ...
    /**
     * Method to make all the sizes availible
     */
